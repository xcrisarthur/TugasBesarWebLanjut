                        ...
                        <table class="table table-hover table-sm">
                            ...
                            @foreach($dkbss as $dkbs)
                                @if($dkbs->hari == $day && !in_array($dkbs->mataKuliah->mk_id, $displayedCourses))
                                    <tr>
                                        <td class="text-start" >{{ $dkbs->mk_id }}</td>
                                        <td class="text-start">{{ $dkbs->mataKuliah->mk_name }}</td>
                                        <td class="text-start">{{ $dkbs->kelas }}</td>
                                        <td class="text-start">{{ $dkbs->ruangan->nama }}</td>
                                        <td class="text-start">{{ $dkbs->jam_mulai }} - {{ $dkbs->jam_selesai }}</td>
                                    </tr>
                                    @php
